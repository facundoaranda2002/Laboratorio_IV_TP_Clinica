...
@Component({
  ...
  standalone: true,
  imports: [MatCard, MatCardTitle, ReactiveFormsModule, MatFormField, MatLabel, MatSelect, MatOption, MatProgressSpinner, NgIf, NgFor, DoctorPipe, CommonModule, GrillaBotonesComponent, FechaPipe],
...
export class SolicitarTurnoComponent {
  ...
  constructor(private firestore:FirestoreService,private formBuilder :FormBuilder,private auth : FirebaseAuthService,public dialog: MatDialog,
