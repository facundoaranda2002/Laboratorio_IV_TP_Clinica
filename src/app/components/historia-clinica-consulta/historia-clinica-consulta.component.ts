...
@Component({
  ...
  standalone: true,
  imports: [NgIf, MatCard, MatCardTitle, NgFor, MatTooltipModule, MatTable, MatIcon, CommonModule, DoctorPipe, MatPaginator, ReactiveFormsModule, MatProgressSpinnerModule, MatFormField, MatLabel, MatSelect, MatOption, MatTableModule, FechaPipe],
  templateUrl: './historia-clinica-consulta.component.html',
  styleUrl: './historia-clinica-consulta.component.css'
})
export class HistoriaClinicaConsultaComponent implements AfterContentInit{
  ...
  constructor(private firestore:FirestoreService,private auth: FirebaseAuthService,public dialog: MatDialog, private formBuilder: FormBuilder, private pdfService:PdfServiceService){
