...
@Component({
  ...
  standalone: true,
  imports: [MatCard, MatCardTitle, ReactiveFormsModule, MatProgressSpinner, MatFormField, MatLabel, MatOption, MatSelect, NgIf, DatosPerfilComponent, CommonModule, HistoriaClinicaConsultaComponent],
