...
import { FormularioEspecialistasComponent } from '../formulario-especialistas/formulario-especialistas.component';
...
export class SeccionUsuariosComponent {
  ...
  agregarEspecialista(){
    const dialogRef = this.dialog.open(FormularioEspecialistasComponent, {
      width: '800px',
    });
  ...
  agregarPaciente(){
    const dialogRef = this.dialog.open(FormularioPacientesComponent, {
      width: '800px',
    });
